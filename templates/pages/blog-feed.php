...
function blog_feed() {
	...
	<div class="blog-feed-news">
		<div class="container more-news cpt-list"
			...
			while ( $query->have_posts() ) :
				...
				<div class="blog-feed__item more-news__item">
					<div class="blog-feed__item__image more-news__item__image">
						<?php
					...
					<h5 class="blog-feed__item__title more-news__item__title"><?php the_title(); ?></h5>
		...
		<div class="blog-feed-pagination">
			<button class="pagination-cta pagination-prev">Previous</button>
			<button class="pagination-cta pagination-next">Next</button>
		</div>
		<!-- // 9 posts per page

		// echo '<div class="blog-feed-pagination">';

		// echo '<a href="' . get_pagenum_link( $current_page - 1 ) . '" class="pagination-cta pagination-prev">Previous</a>';
		// echo paginate_links(
		// 	array(
		// 		'total'              => $total_pages,
		// 		'prev_text'          => '',
		...
		// 	)
		// );
		// echo '<a href="' . get_pagenum_link( $current_page + 1 ) . '" class="pagination-cta pagination-next">Next</a>';
		// echo '</div>';
		?> -->
	</div>
	<?php endif; ?>
