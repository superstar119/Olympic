...
function single_hot_tubs_shortcode() {
			...
			<div class="hot-tub-intro__content">
				...
				get_template_part_args(
					...
					array(
						'v' => 'get_price_cta',
						'o' => 'f',
						'c' => 'hot-tub-intro__content__cta btn btn-blue btn-move text-upper',
					)
				);
				?>
			</div>
	...
	<div class="hot-tub__specification">
		<div class="container">
			<div class="custom-wave custom-wave__top"></div>
			...
			<div class="hot-tub__specification__info">
				...
				<div class="info-right">
					<ul class="info-right__specs">
						...
						<li class="info-right__specs__item">
							<h5 class="item-title text-upper">Dimentions</h5>
							<p class="specs-item__data"><?php echo esc_html( $dimentions ); ?></p>
						</li>
						<li class="info-right__specs__item">
						...
						<li class="info-right__specs__item">
							...
							<p class="specs-item__data"><?php echo esc_html( $weight ); ?></p>
						</li>
						<li class="info-right__specs__item">
							<h5 class="item-title text-upper">Jets</h5>
							<p class="specs-item__data"><?php echo esc_html( $jets ); ?></p>
						</li>
						<li class="info-right__specs__item">
...
function single_hot_tubs_category_shortcode() {
	ob_start();
	global $post;
	$terms = get_the_terms( get_the_ID(), 'hot_tubs_cat' );
	if ( $terms ) :
		?>
...
add_shortcode( 'single_hot_tubs_category_shortcode', 'single_hot_tubs_category_shortcode' );
